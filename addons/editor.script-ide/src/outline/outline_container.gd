...
const OutlineButton := preload("res://addons/editor.script-ide/src/outline/outline_button.gd")

const Plugin := preload("res://addons/editor.script-ide/plugin.gd")
	...
	for line: String in lines:
		...
		if (modifier != &"" && line.begins_with(modifier)):
			if (line.begins_with(modifier + " " + type_with_text)):
				plugin.goto_line(index)
				return
			if (modifier == &"enum" && line.contains("enum " + text)):
				plugin.goto_line(index)
				return
...
func init_icons():
	engine_func_icon = create_editor_texture(load("res://addons/editor.script-ide/assets/icons/engine_func.svg"))
	func_icon = create_editor_texture(load("res://addons/editor.script-ide/assets/icons/func.svg"))
	func_get_icon = create_editor_texture(load("res://addons/editor.script-ide/assets/icons/func_get.svg"))
	func_set_icon = create_editor_texture(load("res://addons/editor.script-ide/assets/icons/func_set.svg"))
	property_icon = create_editor_texture(load("res://addons/editor.script-ide/assets/icons/property.svg"))
	export_icon = create_editor_texture(load("res://addons/editor.script-ide/assets/icons/export.svg"))
	signal_icon = create_editor_texture(load("res://addons/editor.script-ide/assets/icons/signal.svg"))
	constant_icon = create_editor_texture(load("res://addons/editor.script-ide/assets/icons/constant.svg"))
	class_icon = create_editor_texture(load("res://addons/editor.script-ide/assets/icons/class.svg"))
