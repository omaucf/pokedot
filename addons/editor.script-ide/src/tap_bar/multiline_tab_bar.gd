...
const CustomTab := preload("res://addons/editor.script-ide/src/tap_bar/custom_tab.gd")
...
func _ready() -> void:
	...
	_style_icon_button(popup_btn)
	_style_icon_button(split_btn)
...
func _style_icon_button(btn: Button) -> void:
	...
	btn.add_theme_color_override("icon_normal_color", Color(1, 1, 1, 0.5))
	btn.add_theme_color_override("icon_hover_color", Color(1, 1, 1, 1.0))
	btn.add_theme_color_override("icon_pressed_color", Color(0.7, 0.7, 1, 1.0))
